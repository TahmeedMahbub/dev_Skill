...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=4108520598ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ds&table=items">`ds`.`items`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ds&table=subitems">`ds`.`subitems`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mats&table=userlogins">`mats`.`userlogins`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mats&table=students">`mats`.`students`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mats&table=certificates">`mats`.`certificates`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2b333c4c70706624756c654778496961">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="mats" targettable="students">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `students`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="mats" targettable="certificates">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `certificates`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="mats" targettable="userlogins">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `userlogins`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="mats" targettable="students">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `ds`.`items` ( `id` INT NOT NULL AUTO_INCREMENT ,  `val` VARCHAR(500) NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="ds" targettable="items">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `items` (`id`, `val`) VALUES (NULL, &#039;abc&#039;), (NULL, &#039;def&#039;), (NULL, &#039;ghi&#039;), (NULL, &#039;jkl\r\n&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ds" targettable="items">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `items`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ds" targettable="items">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `items`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="ds" targettable="subitems">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `ds`.`subitems` ( `id` INT NOT NULL AUTO_INCREMENT ,  `val` VARCHAR(500) NULL ,  `i_id` INT NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ds" targettable="subitems">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `subitems`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="ds" targettable="subitems">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `subitems` (`id`, `val`, `i_id`) VALUES (NULL, &#039;123&#039;, &#039;1&#039;), (NULL, &#039;456&#039;, &#039;2&#039;), (NULL, &#039;789&#039;, &#039;1&#039;), (NULL, &#039;1112&#039;, &#039;1&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ds" targettable="items">
                            <div class="action_content">
